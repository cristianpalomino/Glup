...
public class Master extends ActionBarActivity {
    ...
    public void setTipos(ArrayList<Tipo_DTO> tipos) {
        ((Glup_Application)getApplication()).setTipos(tipos);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        data = new Glup_Datasource();
    }

    public Glup_Datasource getData() {
        return data;
    }

    public void setData(Glup_Datasource data) {
        this.data = data;
    }
    ...
    /**
     * Capturing Camara Image will lauch camera app requrest image capture
     */
